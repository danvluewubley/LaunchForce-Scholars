  ...
  return (
    <div className="w-full">
      ...
      <div className="pl-[100px]">
        <h2 className="font-anton text-[80px]">Program Compass</h2>
        <p className="font-anonymous text-[40px] pb-[50px]">
          A tool designed to search through hundreds of programs which you can
          tailor to your interests and career ambitions.
        </p>
      </div>
      <div className="pl-[100px]">
        <h2 className="font-anton text-[80px]">Match & Revise</h2>
        <p className="font-anonymous text-[40px] pb-[50px]">
      ...
      <div className="pl-[100px]">
        <h2 className="font-anton text-[80px]">Admissions Insider</h2>
        <p className="font-anonymous text-[40px] pb-[50px]">
      ...
      <div className="pl-[100px]">
        <h2 className="font-anton text-[80px]">Join Our Community</h2>
        <p className="font-anonymous text-[40px] pb-[50px]">
      ...
      <div className="pl-[100px]">
        <h2 className="font-anton text-[80px]">Email List</h2>
        <p className="font-anonymous text-[40px] pb-[50px]">
      ...
      <div className="pl-[100px]">
        <h2 className="font-anton text-[80px]">Apply to Our Team</h2>
        <p className="font-anonymous text-[40px] pb-[50px]">
